...
export default function SignUp() {
  ...
  // optional: store name later in profile table
  ...
  return (
    <main className="min-h-screen grid md:grid-cols-2 bg-[#F8FAFC]">
      ...
      {/* <div className="hidden md:flex flex-col justify-center px-12 bg-gradient-to-br from-[#355834] to-[#71B48D] text-white">
        <h2 className="text-4xl font-bold mb-4">Join Invoxa</h2>
      ...
      {/* <div className="relative hidden md:flex items-end justify-start px-12 py-12 overflow-hidden bg-gradient-to-br from-[#355834] to-[#71B48D] text-white">
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-6 shadow-2xl z-10"
        >
          <Image src="/illustration.svg" alt="Login" width={600} height={600} />
        </motion.div>
      ...
      <div className="flex items-center justify-center px-6">
        ...
        >
          ...
          <p className="text-sm mt-6 text-center">
            ...
            <Link href="/login" className="text-[#355834]">
              Login
            </Link>
          </p>
        </motion.div>
